...
function DynamoDB(dynamoDB) {
    ...
    var AWS = isNotBrowser ? require("aws-sdk") : window.AWS;

    var condition = isNotBrowser ? require("./condition").DynamoDBCondition : window.DynamoDBCondition;

    var datatypes = isNotBrowser ? require("./datatypes").DynamoDBDatatype : window.DynamoDBDatatype;
    var t = new datatypes();

    var formatter = isNotBrowser ? require("./formatter").DynamoDBFormatter : window.DynamoDBFormatter;
    var f = new formatter();
    ...
    service.setupRequestListeners = function(request) {
        ...
        request.on("build", f.setCustomAgent)
